...
{
	class Rifle_Base;
	class PNC_AUGA3_Base: Rifle_Base
	{
		scope=0;
		weight=3454;
		absorbency=0;
	...
	class PNC_W_AUGA3: PNC_AUGA3_Base
	{
		scope=2;
		displayName="Aug A3";
		descriptionShort="#AugA3_00";
		model="PanaceaWeapons\AugA3\AugA3.p3d";
		attachments[]=
		{
			"weaponWrap",
			"weaponOptics",
				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"PanaceaWeapons\AugA3\data\material.rvmat"
							}
						},
						...
						
						{
							...
							{
								"PanaceaWeapons\AugA3\data\material_damage.rvmat"
							}
						},
						...
						
						{
							...
							{
								"PanaceaWeapons\AugA3\data\material_destruct.rvmat"
							}
						}
					};
				};
