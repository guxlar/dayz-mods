...
class cfgWeapons
{
	...
	class M200_Base: BoltActionRifle_Base
	{
		scope=0;
		displayName="M200";
		descriptionShort="#M200_00";
		weight=6500;
		model="PanaceaWeapons\M200\M200.p3d";
		absorbency=0;
				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"PanaceaWeapons\M200\data\material.rvmat"
							}
						},
...
{
	class Magazine_Base;
	class PNC_M200_Mag: Magazine_Base
	{
		scope=2;
		displayName="M200 Magazine";
		descriptionShort="M200 Magazine";
		model="PanaceaWeapons\M200\magazine\m200_mag.p3d";
		weight=400;
		itemSize[]={2,3};
		count=7;
				...
				class Health
				{
					...
					healthLevels[]=
					{
						...
						
						{
							...
							{
								"PanaceaWeapons\M200\data\material_damage.rvmat"
							}
						},
						...
						
						{
							...
							{
								"PanaceaWeapons\M200\data\material_destruct.rvmat"
							}
						}
					};
				};
