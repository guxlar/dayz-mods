...
{
	bool ShowLogo = true;
	string LogoPath = "RENACIMIENTO_DM_LoadingScreen/LoadingScreen/GUI/logo.edds";
	bool RandomizeBackgounds = true;
	int LoadingBarColor = ARGB(255, 199, 38, 81);
	bool UseCustomHints = true;
	string HintIconPath = "RENACIMIENTO_DM_LoadingScreen/LoadingScreen/GUI/icons/circle_info.edds";
	...
	void CustomLoadingScreenData()
	{
		...
		JsonFileLoader<array<ref CustomLoadingScreenBackground>>.JsonLoadFile("RENACIMIENTO_DM_LoadingScreen/LoadingScreen/Scripts/Data/LoadingImages.json", m_ExBackgrounds);
	}
};

modded class UiHintPanel
{
	protected const string 	m_ExDataPath = "RENACIMIENTO_DM_LoadingScreen/LoadingScreen/Scripts/Data/Hints.json"; //! Custom hints json path
...
modded class LoadingScreen
{
	...
	void LoadingScreen(DayZGame game)
	{
		...
		m_ExHintIcon = ImageWidget.Cast(game.GetLoadingWorkspace().CreateWidgets("RENACIMIENTO_DM_LoadingScreen/LoadingScreen/GUI/layouts/hint_icon.layout", m_ExPanelWidget));
		...
		if (m_ExCustomLoadingScreenData.ShowLogo && m_ExCustomLoadingScreenData.LogoPath != string.Empty)
		{
			...
			m_ImageLogoCorner = ImageWidget.Cast(game.GetLoadingWorkspace().CreateWidgets("RENACIMIENTO_DM_LoadingScreen/LoadingScreen/GUI/layouts/logo.layout", m_ExPanelWidget));
		...
		if (m_ExCustomLoadingScreenData.LoadingBarColor != 0)
		{
			...
			m_ProgressLoading = ProgressBarWidget.Cast(game.GetLoadingWorkspace().CreateWidgets("RENACIMIENTO_DM_LoadingScreen/LoadingScreen/GUI/layouts/loading_bar.layout", m_ExPanelWidget));
